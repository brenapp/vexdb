...
export declare type StringRequest<T, S = string> = S | S[] | RegExp | StringRequestValidatorFunction<T, S>;
export declare type StringRequestValidatorFunction<T, S> = (itemValue: S, item: T) => Promise<boolean> | boolean;
...
export interface TeamsRequestObject {
    ...
    grade?: StringRequest<TeamsResponseObject, "College" | "High School" | "Middle School">;
