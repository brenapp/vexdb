...
export declare type Filter<ResponseObject, Key extends keyof ResponseObject, Direct extends ResponseObject[Key]> = ((key: ResponseObject[Key], full: ResponseObject) => Promise<boolean> | boolean) | Direct;
