import { TeamsResponseObject, EventsResponseObject, MatchesResponseObject, RankingsResponseObject, SeasonRankingsResponseObject, AwardsResponseObject, SkillsResponseObject } from "./ResponseObjects";
export declare type Endpoint = "events" | "teams" | "matches" | "rankings" | "season_rankings" | "awards" | "skills";
export declare type StringRequest<T> = string | string[] | RegExp | StringRequestValidatorFunction<T>;
export declare type StringRequestValidatorFunction<T> = (itemValue: string, item: T) => Promise<boolean> | boolean;
export declare type NumberRequest<T> = number | number[] | NumberRequestValidatorFunction<T>;
export declare type NumberRequestValidatorFunction<T> = (itemValue: number, item: T) => Promise<boolean> | boolean;
